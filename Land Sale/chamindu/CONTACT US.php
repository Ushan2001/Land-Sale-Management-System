...
if(isset($_POST['submit']))
{
    ...
    $sql1 = "INSERT INTO contact(name, phone, email, message) VALUES ('$name', '$phone', '$email', '$message')";
    $result = mysqli_query($connect, $sql1);
//check the if condtion 
    if($result) {
        $sql2 = "SELECT * FROM contact WHERE name = '$name'";
        ...
        header('Location:http://localhost/Land%20Sale/chamindu/contactusdashboard.php');
        exit;
    }
    else {
...
<body>
 ...
 <textarea class="t1" readonly="readonly"rows="10" cols="30" >
